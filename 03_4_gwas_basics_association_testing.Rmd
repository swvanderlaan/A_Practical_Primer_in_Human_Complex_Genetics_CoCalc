...
knitr::include_graphics(rep("img/_gwas_dummy/show-hwe-gwas.png"))
```
...
knitr::include_graphics(rep("img/_gwas_dummy/show-freq-gwas.png"))
```
...
knitr::include_graphics(rep("img/_gwas_dummy/show-sample-callrate-gwas.png"))
```
...
knitr::include_graphics(rep("img/_gwas_dummy/show-snp-callrate-gwas.png"))
```
...
```{r load-gwas-assoc, eval = FALSE, message = FALSE, warning = FALSE}
