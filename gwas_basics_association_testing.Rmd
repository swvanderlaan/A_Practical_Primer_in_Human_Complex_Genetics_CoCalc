...
```{r show-hwe-gwas, message=FALSE, warning=FALSE, eval=FALSE}
library("ggpubr")
...
```{r show-freq-gwas, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r show-sample-callrate-gwas, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r show-snp-callrate-gwas, message=FALSE, warning=FALSE, eval=FALSE}
