...
```{r showsnpcallrate, fig.align='center', fig.cap='Per SNP call rate.', fig.show = TRUE, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r showfreq, fig.align='center', fig.cap='Minor allele frequency.', fig.show = TRUE, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r showhwe, fig.align='center', fig.cap='Hardy-Weinberg Equilibrium p-values per stratum.', fig.show = TRUE, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
