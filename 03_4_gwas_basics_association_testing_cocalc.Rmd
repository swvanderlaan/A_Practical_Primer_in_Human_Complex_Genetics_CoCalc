...
```{r, fig.id='showhwegwas', fig.align='center', fig.cap='Per stratum HWE p-values.', fig.show = TRUE, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r, fig.id='showfreqgwas', fig.align='center', fig.cap='Minor allele frequencies.', fig.show = TRUE, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r, fig.id='showsamplecallrategwas', fig.align='center', fig.cap='Per sample call rates.', fig.show = TRUE, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r, fig.id='showsnpcallrategwas', fig.align='center', fig.cap='Per SNP call rates.', fig.show = TRUE, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
