...
```{r show-qq, message=FALSE, warning=FALSE, eval=FALSE}
library("qqman")
...
```{r show-manhattan, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r prep-cmplot, message=FALSE, warning=FALSE, eval=FALSE}
gwas_assoc_complsub <- subset(gwas_assoc_compl, select = c("SNP", "CHR", "BP", "P"))
```


```{r show-cmplot-all, message=FALSE, warning=FALSE, eval=FALSE}
library("CMplot")
