...
```{r show-snp-callrate, message=FALSE, warning=FALSE, eval=FALSE}
library("ggpubr")
...
```{r show-freq, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r show-hwe, message=FALSE, warning=FALSE, eval=FALSE}
