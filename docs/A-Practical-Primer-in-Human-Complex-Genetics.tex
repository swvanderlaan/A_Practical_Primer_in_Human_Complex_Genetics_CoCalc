...
\date{Version 1.0.0beta \textbar{} last update: 2022-04-05}
...
\url{https://www.dropbox.com/sh/iu9rkvnoiwxnzdb/AACkd-7E1-MywkQalo0b4wAda?dl=0}

Make sure you put the data in the \passthrough{\lstinline!\~/Desktop/practical/!} folder.

You \emph{may} need the third dataset \emph{depending on the availability of a program}, which you can download through the link below (approx. 11Gb). \textbf{Don't download it now.}
...
{\centering \includegraphics[width=18.67in]{img/sample-callrate} 
...
{\centering \includegraphics[width=18.67in]{img/show-freq} 
...
{\centering \includegraphics[width=18.67in]{img/WTCCC1 callrate SNPs} 
...
{\centering \includegraphics[width=18.67in]{img/WTCCC1-pca-1000g} 
...
{\centering \includegraphics[width=18.67in]{img/WTCCC1ResultsManhattan-manhattan} 
...
{\centering \includegraphics[width=18.67in]{img/WTCCC1ResultsManhattan-circular} 
