...
Clumping identifies three loci and now that you know them, you can visualize them using LocusZoom. First, let's get what we need (\passthrough{\lstinline!SNP!} and \passthrough{\lstinline!P!}) and gzip the results.
...
Now you are ready to upload this \passthrough{\lstinline!data.assoc.logistic.locuszoom.gz!} file to the site: \url{http://locuszoom.org}. Try to visualize each locus using the information above and by following the instructions. Choose HapMap 2, hg18, CEU as the LD-reference.
