...
**Clumping** can easily be done in PLINK. And you can too with the dummy GWAS dataset in this additional chapter \@ref(regional_plot). You don't have to do it now. You can choose to do it when you have time. 
