...
# About this primer
<img src="https://github.com/swvanderlaan/A_Practical_Primer_in_Human_Complex_Genetics/blob/master/img/_headers/banner_man_standing_dna.png" style="position:absolute;top:50px;height:300px;align:center;" />
option 1 - above the header
![option 2](./img/_headers/banner_man_standing_dna.png){width=100%}

![option 3](img/_headers/banner_man_standing_dna.png){width=100%}
