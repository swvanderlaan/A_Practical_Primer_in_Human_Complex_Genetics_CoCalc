...
\midrule
\endhead
PLINK \url{https://www.cog-genomics.org/plink2/} PLINK is a free, open-source genetic analysis tool set, designed to perform a range of basic data parsing and quality control, as well as basic and large-scale analyses in a computationally efficient manner. \\
R \href{https://cran.r-project.org/}{https://cran.r-project.org} A program to perform statistical analysis and visualizations. \\
RStudio \url{https://www.rstudio.com} A user-friendly R-wrap-around for code editing, debugging, analyses, and visualization. \\
Homebrew \url{https://brew.sh} A great extension for Mac-users to install really useful programs that Apple didn't. \\
\bottomrule
\end{longtable}
