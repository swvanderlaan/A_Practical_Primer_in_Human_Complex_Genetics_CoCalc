...
```{r 'cocalcnotebookgetwd', fig.align='center', fig.cap='CoCalc get working directory.', fig.show = TRUE, eval=TRUE}
knitr::include_graphics("img/_cocalc/cocalc_notebook_getwd.png")
```

Or you could list the contents of the working directory by typing `list.files()` or `dir()` in a cell and pressing `Shift+Enter`.

```{r 'cocalcnotebooklistfiles', fig.align='center', fig.cap='CoCalc list files.', fig.show = TRUE, eval=TRUE}
knitr::include_graphics("img/_cocalc/cocalc_notebook_listfiles.png")
```
...
```{r 'cocalcnotebookplot', fig.align='center', fig.cap='CoCalc plot.', fig.show = TRUE, eval=TRUE}
knitr::include_graphics("img/_cocalc/cocalc_notebook_plot.png")
```
...
```{r 'cocalcterminalselect', fig.align='center', fig.cap='CoCalc new terminal.', fig.show = TRUE, eval=TRUE}
knitr::include_graphics("img/_cocalc/cocalc_terminal_select.png")
```

Type in 'My Terminal' and hit the _Create_ button.

```{r 'cocalcterminalcreate', fig.align='center', fig.cap='CoCalc new terminal creation.', fig.show = TRUE, eval=TRUE}
knitr::include_graphics("img/_cocalc/cocalc_terminal.png")
```

A new tab will open with a Terminal. 

```{r 'cocalcterminalkernel', fig.align='center', fig.cap='CoCalc terminal window.', fig.show = TRUE, eval=TRUE}
knitr::include_graphics("img/_cocalc/cocalc_terminal_window.png")
```
...
```{r 'cocalcterminalwindowls', fig.align='center', fig.cap='CoCalc listing the contents of the directory.', fig.show = TRUE, eval=TRUE}
knitr::include_graphics("img/_cocalc/cocalc_terminal_window_ls.png")
```
...
```{r 'cocalcterminalwindowdata', fig.align='center', fig.cap='CoCalc terminal window.', fig.show = TRUE, eval=TRUE}
knitr::include_graphics("img/_cocalc/cocalc_terminal_window_data.png")
```

Let's check out the contents of the `readme.txt` file. 

```{r 'cocalcterminalwindowreadme', fig.align='center', fig.cap='CoCalc readme file.', fig.show = TRUE, eval=TRUE}
knitr::include_graphics("img/_cocalc/cocalc_terminal_window_readme.png")
```
...
```{r 'cocalcterminalwindowplink', fig.align='center', fig.cap='CoCalc plink.', fig.show = TRUE, eval=TRUE}
knitr::include_graphics("img/_cocalc/cocalc_terminal_window_plink.png")
```
