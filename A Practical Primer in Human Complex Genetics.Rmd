...
knitr::include_graphics("img/sample-callrate.png")
...
raw_IMISSHETsub <- data.table::fread("data/fail-raw_IMISSHETsub.txt")
```
...
knitr::include_graphics("img/pca-hapmap3.png")
```
...
knitr::include_graphics("img/pca-1000g.png")
```
...
knitr::include_graphics(rep("img/show-qq.png"))
```
...
knitr::include_graphics(rep("img/show-manhattan.png"))
```
...
knitr::include_graphics(rep("img/show-cmplot-all-density.png"))
```
...
knitr::include_graphics(rep("img/show-cmplot-all-qq.png"))
```
...
knitr::include_graphics(rep("img/show-cmplot-all-manhattan.png"))
```
...
knitr::include_graphics(rep("img/show-cmplot-all-circular.png"))
```
...
knitr::include_graphics("img/WTCCC1 HWE.png")
```
...
knitr::include_graphics(rep("img/WTCCC1 FREQ.png"))
```
...
knitr::include_graphics(rep("img/WTCCC1 callrate samples.png"))
```
...
knitr::include_graphics(rep("img/WTCCC1 callrate SNPs.png"))
```
...
knitr::include_graphics(rep("img/WTCCC1-pca-1000g.png"))
```
...
knitr::include_graphics(rep("img/WTCCC1ResultsManhattan-density.png"))
```
...
knitr::include_graphics(rep("img/WTCCC1ResultsManhattan-qq.png"))
```
...
knitr::include_graphics(rep("img/WTCCC1ResultsManhattan-manhattan.png"))
```
...
knitr::include_graphics(rep("img/WTCCC1ResultsManhattan-circular.png"))
```
...
knitr::include_graphics(rep("img/rs6802898.rs6802898.regional_assoc.png"))
knitr::include_graphics(rep("img/rs7901695.rs7901695.regional_assoc.png"))
knitr::include_graphics(rep("img/rs8050136.rs8050136.regional_assoc.png"))
