...
```{r, tab.id = "programs", tab.cap = "Programs needed for genetic epidemiology.", eval = TRUE, echo = FALSE, include = FALSE}
# knitr::kable(
#   programs,
...
```{r 'plinkprogram', fig.align='center', fig.cap='The PLINK v1.9 website.', fig.show = TRUE, eval=TRUE, echo = FALSE, include = FALSE}
