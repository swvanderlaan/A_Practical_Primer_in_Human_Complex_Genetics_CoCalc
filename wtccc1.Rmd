...
```{r WTCCC1 FREQ, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r pca-1000g-wtccc, message=FALSE, warning=FALSE, out.width='80%', fig.align='center', fig.asp=.75, fig.cap='PCA - WTCCC1 vs. 1000G', eval=FALSE}
