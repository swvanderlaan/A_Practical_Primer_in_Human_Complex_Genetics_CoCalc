...
author: "[dr. Sander W. van der Laan](https://swvanderlaan.github.iio)"
date: "`r Sys.Date()`"
...
Welcome to the course 'Genetic Epidemiology', and this practical entitled 'A primer in Human Cardiovascular Genetics'. In the next few days we will use this [GitBook](https://cjvanlissa.github.io/gitbook-demo/) to perform quality control (QC), executing a genome-wide association study (GWAS), annotating the GWAS results, and performing further downstream analyses. We will use data from the first release of the [*Welcome Trust Case-Control Consortium (WTCCC)*](https://www.wtccc.org.uk/ccc1/overview.html){target="_blank"} and focus on coronary artery disease (CAD). 

We won't have time to perform [imputation](https://www.nature.com/articles/nrg2796), but we will provide some pointers as to how to do this with minimal coding/scripting experience.
...
--------------
![](img/_team/charlotte_onland.jpg){width=15%} Charlotte Onland-Moret </br>_Associate Professor_</br><N.C.Onland@umcutrecht.nl> 

![](img/_team/sander_vander_laan.jpg){width=15%} Sander W. van der Laan </br>_Assistant professor_</br><s.w.vanderlaan-2@umcutrecht.nl> | [swvanderlaan](http://www.twitter.com/swvanderlaan){target="_blank"}
...
[](img/_team/jessica_van_setten.jpg){width=15%} Jessica van Setten </br>_Assistant professor_</br><j.vansetten@umcutrecht.nl> | [j_vansetten](http://www.twitter.com/j_vansetten){target="_blank"}
