...
knitr::include_graphics(rep("img/_gwas_dummy/show-snp-callrate.png"))
```
...
knitr::include_graphics(rep("img/_gwas_dummy/show-freq.png"))
```
...
knitr::include_graphics(rep("img/_gwas_dummy/show-hwe.png"))
```
